...
这是概念参考，不是实测户型或施工下料图。约 98.4㎡ 为概念室内净地面（含柜体占地，露台另计），不等同于建筑面积。写实图片由 AI 生成，尺寸和结构以图纸为准；柜体名义分区仍需扣除板材、五金与管线占位。设备选型、结构、防水、电气、维护净空与当地要求需在施工前由专业人员复核。
...
最新首页客厅为 `dist/assets/living-mobile-v6.webp`。新增后部检修图、卧室修正版、家政正立面修正版；提示词与资产路径见 `scripts/image-prompts-v6.md`。使用内置图像生成工具。

- 以跨房间移动优先，暂按55英寸级电视；原98英寸仅作为另一种取舍说明。C02改为1100×360×550mm柜体和独立承重柜架，非已选量产产品。
- 保留同色素墙、低位插座和踢脚防护，取消固定长影音柜；T02为450×350×550mm带锁脚轮边几。
- 客厅连接开口名义2220mm，卧室入口名义1320mm。净地面概念面积随开口变化为98.428㎡，页面四舍五入98.4㎡。
- 沙发靠东侧定位，外沿到墙50mm；四张平面、沙发尺寸图、柜体图和图片引用同步到V6。
- 移动路径为1250×600mm包络的二维概念检查，先移开边几和餐桌。未模拟人的站位、门扇、门套、门槛、电线、实际产品重心；不得当作施工或搬运保证。
- 六个主空间逐项核对记录可在布局章节展开。效果图的材质和透视不作为尺寸依据。
