...
for mode in ['layout','life','robot']:
 ...
 (A/f'plan-{mode}-v5.svg').write_text(out)
...
def photo(name,alt,cls='',eager=False):
 name={'living':'living-fixed-v5','study':'study-v2','kitchen':'kitchen-v4','bathroom':'bathroom-v4'}.get(name,name)
...
def diagram(name,alt):
 name=name+'-v5' if name.startswith('plan-') else name
...
rooms=[
('living','01','客厅','把时间，留给一部电影。','大屏、能窝进去的沙发、顺手拿到的水。放松不需要复杂的场景，也不需要填满每一面墙。',[('98 英寸电视','电视在图左侧墙，沙发在图右侧；效果图朝露台看，因此画面左右相反。以电视＋NAS 为核心。按最终电视尺寸、坐姿与现场距离试看，不把普通观影升级成家庭影院。'),('固定布艺沙发＋长贵妃榻','低靠背、深坐面与同高贵妃榻，随时可以把腿放上来。净躺区目标约 1850 × 1000mm，按 170cm 身高试躺，靠垫承托腰背。'),('清扫有明确边界','悬浮影音柜底部预留 180mm。沙发采用封闭落地底座，机器人沿外轮廓清扫；主要通路与贵妃榻前方保持畅通，边角人工补扫。')],'C02'),
